...
%>
<%-- Admin notifications page: publishes/removes global announcements; TA/MO pages are read-only views of the same stream. --%>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <script>
        // Injected for admin-notifications.js as a shared routing utility.
