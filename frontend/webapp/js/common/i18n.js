        ...
        "en": {
            ...
            portal: {
                ...
                taJobList: {
                    ...
                    aiOutOfScope: "I cannot handle your question. I can recommend jobs, compare jobs, or explain recommendation reasons based on your profile and open positions you have not applied to yet.",
                    aiRecommendationTitle: "Recommendation (AI generated)",
                    aiRecommendedUnit: "AI recommendation",
                    aiNoRecommendations: "No AI recommendations for open positions you have not applied to yet.",
                    aiNoRecommendationsHint: "Try asking for a different teaching focus or check again when more unapplied open jobs are available.",
        ...
        "zh-CN": {
            ...
            portal: {
                ...
                taJobList: {
                    ...
                    aiOutOfScope: "我无法处理您的问题。我可以根据你的个人档案和你尚未申请的开放职位，帮你推荐职位、比较职位或解释推荐理由。",
                    aiRecommendationTitle: "推荐建议（AI生成）",
                    aiRecommendedUnit: "AI 推荐",
                    aiNoRecommendations: "你尚未申请的开放职位暂无 AI 推荐结果。",
                    aiNoRecommendationsHint: "可以换一个教学重点再试，或等有更多尚未申请的开放职位后再查看。",
                    alreadyApplied: "已申请",
                    applicationAccepted: "已通过",
                    applicationRejected: "已拒绝",
                    applicationWithdrawn: "已撤回",
